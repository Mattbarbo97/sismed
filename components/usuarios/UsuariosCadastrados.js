        ...
        const fetchUsuarios = async () => {
            ...
            try {
                ...
                for (const docSnap of snapshot.docs) {
                    ...
                    console.log("Dados do usuário:", userData); // Adicionar este log para verificar os dados do usuário
                    ...
                    const docRef = doc(firestore, "dbo.usuario", userData.idFuncao);
                    console.log("Referência do documento:", docRef); // Adicionar este log para verificar a referência do documento
                    const docSnapFuncao = await getDoc(docRef);
